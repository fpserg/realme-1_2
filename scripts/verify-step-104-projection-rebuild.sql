...
-- Synthetic fixtures are transaction-local. Historical time settings are
-- explicitly effective from -infinity so deterministic DST anchors exercise
-- the accepted Step 100 physical-containment law rather than fixture creation time.
...
insert into public.time_settings (
  ...
  ('10400000-0000-4000-8000-000000000003', '10400000-0000-4000-8000-000000000001', 'Europe/Amsterdam', '04:00', '-infinity', '10400000-0000-4000-8000-000000000002'),
  ('10400000-0000-4000-8000-000000000903', '10400000-0000-4000-8000-000000000901', 'Europe/Amsterdam', '04:00', '-infinity', '10400000-0000-4000-8000-000000000902'),
  ('10400000-0000-4000-8000-000000000913', '10400000-0000-4000-8000-000000000911', 'Europe/Amsterdam', '02:30', '-infinity', '10400000-0000-4000-8000-000000000912'),
  ('10400000-0000-4000-8000-000000000923', '10400000-0000-4000-8000-000000000921', 'Europe/Amsterdam', '02:30', '-infinity', '10400000-0000-4000-8000-000000000922');

insert into public.ontology_nodes (id, world_id, admitted_by_decision_id) values
  ('10400000-0000-4000-8000-000000000010', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000011', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000012', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000013', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000014', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000020');
...
insert into public.assertions (
  ...
  ('10400000-0000-4000-8000-000000000100', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000010', 'classification', '"commitment"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000101', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000010', 'commitment_title', '"Canonical A"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000102', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000010', 'commitment_due_local_date', '"2026-08-30"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000103', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000010', 'commitment_status', '"open"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000110', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000011', 'classification', '"commitment"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000111', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000011', 'commitment_title', '"Canonical B"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000112', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000011', 'commitment_due_local_date', '"2026-08-30"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000113', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000011', 'commitment_status', '"open"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000120', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000012', 'classification', '"commitment"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000121', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000012', 'commitment_title', '"Canonical C"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000122', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000012', 'commitment_due_local_date', '"2026-08-30"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000123', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000012', 'commitment_status', '"open"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000130', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000013', 'classification', '"commitment"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000132', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000013', 'commitment_due_local_date', '"2026-08-30"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000133', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000013', 'commitment_status', '"open"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000140', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000014', 'classification', '"commitment"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000142', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000014', 'commitment_due_local_date', '"2026-08-30"', '10400000-0000-4000-8000-000000000020'),
  ('10400000-0000-4000-8000-000000000143', '10400000-0000-4000-8000-000000000001', '10400000-0000-4000-8000-000000000014', 'commitment_status', '"open"', '10400000-0000-4000-8000-000000000020');
...
-- Europe/Amsterdam spring DST gap: civil 02:30 resolves to 03:30 local / 01:30 UTC.
DO $$
BEGIN
  ASSERT private.resolve_operational_date_for_anchor(
    '10400000-0000-4000-8000-000000000911', '2026-03-29 01:15:00+00'
  ) = date '2026-03-28', 'spring DST gap rolled forward early';
  ASSERT private.resolve_operational_date_for_anchor(
...
-- Europe/Amsterdam fall DST fold: Step 100 chooses the earlier physical 02:30 occurrence.
DO $$
BEGIN
  ASSERT private.resolve_operational_date_for_anchor(
  ...
  ) = date '2026-10-25', 'fall DST fold repeated hour failed';
END;
$$;
...
DO $$
BEGIN
  ASSERT (SELECT title = 'Canonical A' AND title_assertion_id = '10400000-0000-4000-8000-000000000101'
    FROM public.commitment_projection_source
    WHERE commitment_id = '10400000-0000-4000-8000-000000000010'),
    'admitted title + one alias must project';
  ASSERT (SELECT title = 'Canonical B' AND title_assertion_id = '10400000-0000-4000-8000-000000000111'
    FROM public.commitment_projection_source
  ...
  ASSERT (SELECT title = 'Canonical C' AND title_assertion_id = '10400000-0000-4000-8000-000000000121'
    FROM public.commitment_projection_source
    WHERE commitment_id = '10400000-0000-4000-8000-000000000012'),
    'admitted title + no alias must project';
  ASSERT (SELECT title = 'Alias D' AND title_assertion_id IS NULL
    FROM public.commitment_projection_source
    WHERE commitment_id = '10400000-0000-4000-8000-000000000013'),
    'no admitted title + one alias must use fallback without fabricated provenance';
