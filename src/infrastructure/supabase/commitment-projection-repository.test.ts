...
import {
  SupabaseCommitmentProjectionRepository,
} from "./commitment-projection-repository";

describe("SupabaseCommitmentProjectionRepository", () => {
  it(
    "calls only the bounded read RPC and preserves canonical references",
    async () => {
      const rpc = vi.fn().mockResolvedValue({
        data: [
          {
            classification_assertion_id: "10400000-0000-4000-8000-000000000100",
