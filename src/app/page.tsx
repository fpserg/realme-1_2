    ...
    <aside className={styles.authorityGuide} aria-labelledby="authority-title">
      ...
      <dl>
        ...
        <div>
          <dt>You admitted</dt>
          <dd>
            Current canonical World understanding created only through explicit
            review.
          </dd>
        </div>
        <div>
      ...
      <main className={styles.appMain}>
        ...
        <div className={styles.appSections}>
          ...
          >
            ...
            <CandidateReview
              decisionEndpoint={state.admissionDecisionEndpoint}
          ...
          >
            <div className={styles.sectionIntro}>
              ...
              <div>
                ...
                <p>
                  Canonical understanding is read-only here. The Living World
                  remains a disposable visual projection and currently shows
                  admitted Realm roots only.
                </p>
              </div>
            </div>
            <CanonicalUnderstanding
              items={state.canonicalUnderstanding ?? []}
            />
...
export default async function HomePage() {
  ...
  let state: HomeState;
  try {
    const access = await getCurrentWorld(
      userId,
      new SupabaseWorldAccessRepository(supabase),
    );
